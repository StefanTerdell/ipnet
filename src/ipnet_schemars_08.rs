...
impl JsonSchema for Ipv4Net {
    ...
    fn json_schema(_gen: &mut SchemaGenerator) -> Schema {
        ...
        metadata: Some(Box::new(Metadata {
            ...
            examples: vec![
                schemars08::_serde_json::Value::String("0.0.0.0/0".to_string()),
                schemars08::_serde_json::Value::String("192.168.0.0/24".to_string()),
            ],
            ..Default::default()
        })),
    ...
    fn json_schema(_gen: &mut SchemaGenerator) -> Schema {
        Schema::Object(SchemaObject {
            metadata: Some(Box::new(Metadata {
                ...
                examples: vec![
                    schemars08::_serde_json::Value::String("::/0".to_string()),
                    schemars08::_serde_json::Value::String("fd00::/32".to_string()),
                ],
                ..Default::default()
            })),
            instance_type: Some(SingleOrVec::Single(Box::new(InstanceType::String))),
